        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">Primeira Aula com <span className="text-primary">Desconto de 50%</span></h2>
              <p className="text-gray-600 mb-8">
                Inicie hoje sua jornada de aprendizado com a Explica Conecta e ganhe 50% de desconto na sua primeira aula. Aproveite esta oportunidade para conhecer nossos explicadores qualificados.
              </p>
              ...
              <p className="mt-4 text-sm text-gray-500">*Promoção válida para novos alunos. Sujeita a disponibilidade.</p>
            </div>
            <div className="md:w-1/2 bg-primary/10 p-8 md:p-12 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 relative z-10 w-full max-w-md">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="px-3 py-1 bg-secondary rounded-full text-xs font-medium text-primary">DESCONTO</div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">Explicador personalizado</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-4 h-4 rounded-full bg-primary/20 flex items-center justify-center mr-3">
                      <span className="text-primary text-xs">✓</span>
                    </div>
                    <span className="text-gray-700">Material de estudo exclusivo</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-4 h-4 rounded-full bg-primary/20 flex items-center justify-center mr-3">
                      <span className="text-primary text-xs">✓</span>
                    </div>
                    <span className="text-gray-700">Avaliação de nível gratuita</span>
                  </div>
                </div>
                <Button className="w-full mt-6">Saiba Mais</Button>
              </div>
            </div>
          </div>
        </div>
