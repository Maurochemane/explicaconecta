    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/cadastro-explicadores" element={<CadastroExplicadores />} />
          <Route path="/solicitar-explicador" element={<SolicitarExplicador />} />
          <Route path="/solicitar-proposta-empresas" element={<SolicitarPropostaEmpresas />} />
