        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              <h1 className="text-3xl font-bold text-primary mb-4">Cadastro de Explicadores</h1>
              <p className="text-gray-600 mb-6">
                Junte-se à nossa equipa de explicadores qualificados e ajude estudantes a alcançarem o seu potencial máximo.
              </p>
            </div>
